...
export const metadata = {
  title: "Sitemap",
  description:
    "Navigate through all pages and sections of Xtrawrkx website. Find everything from services and communities to resources and events.",
  openGraph: {
    title: "Sitemap - Xtrawrkx Professional Development Platform",
    description:
      "Complete navigation guide to all Xtrawrkx pages and sections.",
    type: "website",
  },
};
...
export default function SitemapPage() {
  ...
  const resourcePages = [
    ...
    ...resourcesData.slice(0, 10).map((resource) => ({
